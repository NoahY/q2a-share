	...
	// register default settings
		...
		function qa_share_buttons($q_view) {
			...
			$code = array(
				...
				'email'=>'<span id="share-button-email"><a href="mailto:?subject='.str_replace('&','%26','['.htmlspecialchars(qa_opt('site_title').'] '.$q_view['raw']['title'])).'&body='.str_replace('&amp;','%26',$url).'"><img height="20" src="'.dirname($_SERVER['PHP_SELF']).'/mail.png').'"/></a></span>'
			);
